...
async function writeMetadataRows(svc: Svc, userId: string, assetId: string, rec: CanonicalMetadataRecord) {
  ...
  if (rec.exif) {
    ...
    await upsertOne(svc, "asset_exif", {
      ...base,
      exif_make: e.exifMake, exif_model: e.exifModel,
      lens_make: e.lensMake, lens_model: e.lensModel,
      focal_length_35mm: e.focalLength35mm, f_number: e.fNumber,
      exposure_time: e.exposureTime, exposure_mode: e.exposureMode,
      metering_mode: e.meteringMode, software: e.software,
